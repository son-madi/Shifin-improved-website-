        ...
        {!isAdmin && bots.length >= globalBotLimit ? (
          ...
          <motion.button
            ...
            className={`text-xs font-bold flex items-center gap-1.5 px-3 py-1.5 border rounded-xl transition-all cursor-pointer shadow-xs ${
              isColourUI
                ? 'bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-zinc-950 border-emerald-300/50 shadow-[0_0_12px_rgba(16,185,129,0.3)]'
