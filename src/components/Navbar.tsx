...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-30 backdrop-blur-xl border-b px-3.5 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center w-full transition-colors duration-200 ${
          isColourUI
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4 w-full min-w-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            {/* Direct Guest Auth Controls (Sign In & Sign Up) */}
            {!currentUser && (
